...
function getSlides(splide) {
  var _a;
  const children3 = (_a = splide.Components.Elements) == null ? void 0 : _a.list.children;
...
function Elements(Splide2, Components2, options) {
  ...
  function collect() {
    ...
    push(slides, children2(list, "." + CLASS_SLIDE + ":not(." + CLASS_CLONE + ")"));
    forOwn2({
      arrows: CLASS_ARROWS,
      pagination: CLASS_PAGINATION,
      prev: CLASS_ARROW_PREV,
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      claim_component(splidetrack.$$.fragment, nodes);
    },
    m: function mount(target, anchor) {
