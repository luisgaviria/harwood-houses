    ...
    <footer id="colophon" class="site-footer">
      ...
      <div class="left-right">
        <div class="left text-footer-links">
          {#if data.leftfooter}
            {#each data.leftfooter.menutitle as block, index}
              <div id={"block-" + index} class="menu widget_block">
                <div class="menu-title">{block.title}</div>
                <div class="wp-widget-group__inner-blocks">
                  <ul>
                    {#each block.link as blocklink, index2}
                      <li class="no-list-style">
                        <a
                          href={blocklink.href}
                          target="_blank"
                          rel="noreferrer noopener">{blocklink.text}</a
                        >
                      </li>
                    {/each}
                  </ul>
            ...
            {/each}
          {:else}
            <div id={"block-1"} class="menu widget_block">
              <div class="menu-title">{placeholderLayoutText}</div>
              <div class="wp-widget-group__inner-blocks">
                <ul>
                  <li class="no-list-style">
                    <a
                      href={placeholderLayoutText}
                      target="_blank"
                      rel="noreferrer noopener">{placeholderLayoutText}</a
                    >
                  </li>
                </ul>
              </div>
        ...
        <div class="right text-footer-links">
          {#if data.rightfooter}
            {#each data.rightfooter.menutitle as block, index}
              <div id={"block-" + index} class="menu widget_block">
                <div class="menu-title">{block.title}</div>
                <div class="wp-widget-group__inner-blocks">
                  {#each block.link as blocklink, index2}
                    <a href={blocklink.href} class="text-footer-links"
                      >{blocklink.text}</a
                    >
                  {/each}
                </div>
